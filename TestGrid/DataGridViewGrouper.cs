...
// source originally taken from http://blogs.vbcity.com/hotdog/archive/2008/12/19/9226.aspx
namespace TestGrid
{
    /// <summary>
    ...
    public class DataGridViewGrouper : Component, IGrouper
    {
        ...
        public DataGridViewGrouper()
        {
            ...
            source.GroupingChanged += source_GroupingChanged;
        }
        ...
        {
            if (selectedrows.Count == 0 || grid.SelectionMode == DataGridViewSelectionMode.FullRowSelect)
                return;
        ...
        {
            if (grid == null || !GridUsesGroupSource)
                return;
            grid.SuspendLayout();
        ...
        private GroupingSource source = new GroupingSource();
        ...
        private void source_GroupingChanged(object sender, EventArgs e)
        {
            OnGroupOnChanged();
        }
        ...
        {
            get { return source.GroupOn != null; }
        }

        public SortOrder SortOrder
        {
            get { return source.GroupSortDirection; }
            set { source.GroupSortDirection = value; }
        }
        ...
        private Pen linepen = Pens.SteelBlue;
        ...
        {
            if (!DrawExpandCollapseLines || e.RowIndex >= source.Count)
                return;
        ...
        private void OnPaintGroupRow(DataGridViewRowPrePaintEventArgs e)
        {
            ...
            r.X = 1;
            r.Height--;
            using (var b = new SolidBrush(info.SelectionBackColor))
            ...
            //group value
            {
                ...
                using (var fb = new SolidBrush(info.SelectionForeColor))
                {
        ...
        {
            return new Rectangle(HeaderOffset - collapseboxwidth, Y_Offset + CollapseBox_Y_Offset, collapseboxwidth,
                                 collapseboxwidth);
        }
        ...
        public bool CurrentRowIsGroupRow
        {
            get
            {
                if (grid == null || grid.CurrentCell == null)
                    return false;
                bool value = IsGroupRow(grid.CurrentCell.RowIndex);
                return value;
            }
        }
    }
    ...
    public class GroupingSource : BindingSource
    {
        ...
        {
            var pd = GetItemProperties(null)[Name];
            if (pd == null)
        ...
        private bool NeedSync
        {
            get
            {
                if (bsource == null || suspendlistchange)
                    return false;
                if (bsource.IsBindingSuspended)
                    return false;
